/* nand2tetris project 6: my implementation of an assembler that translates a Hack assembly file (.asm) into a Hack machine language file (.hack) */
/* 
potential improvements:
- there is no error-handling for incorrect Hack assembly syntax 
- dynamically allocate space for assembly commands to reduce memory wasteage with MAXCOMMANDLENGTH
